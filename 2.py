...
replacing_the_last_value_of_a_tuple = 100

list_l = [(10, 20, 40), (40, 50, 60, 70), (80, 90), (1000,)]
list_change = [tuple_ch[:-1] + (replacing_the_last_value_of_a_tuple,) for tuple_ch in list_l]

print("Expected Output: {0}".format(list_change))
